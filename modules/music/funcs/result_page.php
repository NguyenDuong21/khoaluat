...
$query = "SELECT * FROM nv4_vi_music_game_max_results as tbl1 where diem = (select max(diem) from nv4_vi_music_game_max_results as tbl2 where tbl1.username = tbl2.username)";
